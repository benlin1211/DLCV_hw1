...
python3 train_1-2.py ${1} ${2} --mode="train" --model_option="C" --learning_rate=5e-5  --checkpth="ckpt_1-2-deeplab" --l2_reg_lambda=5e-5 --scheduler_lr_decay_ratio=0.99 --n_split=99
